...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="user\Welcome.php" class="active"><i class="fas fa-desktop"></i><span>Dashboard</span></a>
    <a href="user\noticebrd.php"><i class="fas fa-bullhorn"></i><span>Notice Board</span></a>
    <a href="user\complaint.php"><i class="fas fa-envelope-open-text"></i><span>Register Complaint</span></a>
  ...
  <div class="content">
    ...
    if ($result->num_rows > 0) {
     ...
     <br><span>Your Flat No.</span></p>
      ...
      <div class="col-div-3">
        <div class="box">
          <p>Swayam Mehta<br><span>Society Secretary</span></p>
